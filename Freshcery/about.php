        ...
        <section class="bg-leaf">
            <div class="container">
                ...
                <div class="row justify-content-center align-items-center mt-3">
                    <div class="col-md-4">
                        <img src="<?php echo IMGURLPRODUCT; ?>/fruits.jpg" class="img-fluid">
                    </div>
                    <div class="col-md-6">
                        <h5>
                ...
                <div class="row justify-content-center align-items-center text-right mt-3">
                    ...
                    <div class="col-md-4">
                        <img src="<?php echo IMGURLPRODUCT; ?>/vegetables.jpg" class="img-fluid">
                    </div>
                </div>

                <div class="row justify-content-center align-items-center mt-3">
                    <div class="col-md-4">
                        <img src="<?php echo IMGURLPRODUCT; ?>/fish.jpg" class="img-fluid">
                    </div>
                    <div class="col-md-6">
                        <h5>
